...
function SearchField() {
  return (
    <div className="relative flex flex-wrap">
        <input type="text" className="relative py-[10px] font-medium px-3 pr-10 w-full bg-white rounded border border-[#dfdfdf] outline-none text-sm text-[#898989] placeholder-gray-400 focus:outline-none focus:shadow-outline" placeholder="Search Product" />
