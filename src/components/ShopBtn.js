...
function ShopBtn() {
  return (
        <div>
            <button className="process-goto hover:bg-gray-12 hover:text-white cursor-pointer absolute flex justify-center text-gray-12 rounded-sm text-xs mt-13p items-center py-2 w-29 dm-sans border border-gray-800">
                <span>Shop Now</span>
